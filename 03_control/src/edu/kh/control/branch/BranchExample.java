...
public class BranchExample {
	...
	public void ex2() {
		...
		while(true) {
			...
			// 비교연산자(==)는 보통 기본자료형끼리의 연산에서만 사용가능
 			//String 은 기본자료형이 아닌 참조형 !!!
		
			// equals() 매서드
			// 문자열1.equals(문자열2)
			// -> 문자열1과 문자열 2가 같으면 true
			//  / 같지않으면 false 반환
	...
	public void RSPGame() {
		...
		for(int i =1; i<= round; i++) {
			...
			System.out.println("\n" + i + "번째 게임");
			System.out.print("가위/바위/보 중 하나입력 : ");
		...
		System.out.printf("현재 기록 : %d승 %무 %d패\n");
