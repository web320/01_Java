...
public class VariableExample2 {
	...
	public static void main(String[] args) {
	 ...
	 booleanData = true; // boolenData 변수에 true 논리값 대입
	 // 값을 변수에 최초로 대입 --> 초기화
	 ...
	 //3. 숫자시작 x ( 숫자 포함은 가능하나 시작은 불가)
	 //char 1abc;
	 char a1bc;
	 
	 // 4.특수문자 $, _만 사용 가능(하지만 쓰지 않는다)
	 int $intNumber;// 문제없음
	 int int_Number; // 자바는 카멜 케이스 사용
	 				//_작성 표기법은 DB에서 사용
	 				// 자바의 상수에서 사용
	 				// PI_VALUE
	 ...
	 //PI_VALUE = 2.23; //에러발생함 ! 재대입 불가
	 
	 /*상수(항상 같은 수)
	  * -변수 한 종류
	  * -한번 값이 대입되면 다른 값을 재대입 할 수 없음!
	  * -자료형 앞에 final 키워드를 작성
	  * -상수 명명 규칙 : 모두 대문자, 단어 구분시_ 사용
	  * 
	  * - 상수를 사용하는 경우
